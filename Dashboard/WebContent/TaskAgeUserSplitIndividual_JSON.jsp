...
<%
	...
	String col[][] =  DatabaseManager.getTaskAgeUserSplitIndividual(request.getParameter("taskname"), request.getParameter("ownername"), Integer.parseInt(temp[0]), Integer.parseInt(temp[1]) ); 
